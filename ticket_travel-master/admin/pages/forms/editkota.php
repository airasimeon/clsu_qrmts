...
$getid =$_GET['id'];
$res = $konek->query("SELECT * FROM kota WHERE id='$getid' ");
...
if(isset($_POST['submit'])){
  ...
  $konek->query("UPDATE kota SET kota='$kota',bandara='$bandara' WHERE id='$getid'");
  header("location:../tables/viewkota.php");
}
?>
<html>
<head>
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              <form method="POST">
                ...
                <div class="form-group">
                  <label>Bandara</label>
                  <input type="text" class="form-control" name="bandara" value="<?php echo $data['bandara'] ?>">
                </div>
                <div>
