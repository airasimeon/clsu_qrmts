...
$getid =$_GET['id'];
$res = $konek->query("SELECT * FROM rute WHERE id='$getid'");
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="date" class="form-control"  name="depart" value="<?php echo $data['depart']; ?>">
                  </div>
                </div>
              </div>
                <div class="bootstrap-timepicker">
                  <div class="form-group">
                      <label>Time</label>
                      <div class="input-group">
                        <input type="time" class="form-control" name="depart_time" value="<?php echo $data['depart_time']; ?>">
                        <div class="input-group-addon">
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="date" class="form-control pull-right" name="arrived" value="<?php echo $data['arrived']; ?>">
                  </div>
                </div>
              </div>
                <div class="bootstrap-timepicker">
