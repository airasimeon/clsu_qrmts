...
if(isset($_POST['submit'])){
 ...
 $bandara = $_POST['bandara'];
  ...
  $konek->query("INSERT INTO kota(kota,bandara) VALUES('$kota','$bandara') ");
        ...
        <div class="col-md-8">
          ...
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Input Kota & Bandara</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form method="POST">
              ...
              <div class="form-group">
                <label>Kota</label>
                <input type="text" class="form-control"  name="kota" required auto>
              </div>
              <div class="form-group">
                <label>Bandara</label>
                <input type="text" class="form-control" name="bandara"  required auto>
              </div>
              <div>
