...
if(isset($_POST['submit'])){
 ...
 $kuota = $_POST['kuota'];
  ...
  $konek->query("INSERT INTO pesawat(kode_p,maskapai,kuota) VALUES('$kode_p','$maskapai','$kuota') ");
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control"  name="kode_p" required auto>
              </div>
              <div class="form-group">
                <label>Maskapai</label>
                <input type="text" class="form-control" name="maskapai"  required auto>
              </div>
              <div class="form-group">
                <label>Kuota</label>
                <input type="number" class="form-control" name="kuota"  required auto>
              </div>
              <div>
