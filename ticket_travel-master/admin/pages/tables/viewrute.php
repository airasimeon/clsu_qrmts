...
$ambilid = $_GET['id'];
$cek = mysqli_query($cn, "SELECT * FROM rute WHERE id='$ambilid'");
  if(mysqli_num_rows($cek) == 0){
    echo '<div class="alert alert-info alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Data tidak ditemukan.</div>';
  }else{
    $delete = mysqli_query($cn, "DELETE FROM rute WHERE id='$ambilid'");
  if($delete){
                    ...
                    if(mysqli_num_rows($sql) == 0){
                      ...
                      while($row = mysqli_fetch_assoc($sql)){
                        ...
                        echo '
                          ...
                          <td>';
                          echo '
                          <a href="../forms/editrute.php?id='.$row['id'].'"title="Edit Data" class="btn btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                          <a href="viewrute.php?aksi=delete&id='.$row['id'].'"title="Hapus Data" onclick="return confirm(\'Data Akan Dihapus?\')"class="btn btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                          </td>
                          </tr>
                        ';
                      }
